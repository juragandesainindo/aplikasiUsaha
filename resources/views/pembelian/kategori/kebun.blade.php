...
<div class="modal fade" id="create">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('pembelian-produksi-kebun.store') }}" method="post">
                @csrf
...
<div class="modal fade" id="edit-{{ $item->id }}">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('pembelian-produksi-kebun.update',$item->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <form action="{{ route('pembelian-produksi-kebun.destroy',$item->id) }}" method="post">
                    @csrf
                    @method('DELETE')
...
<table class="table table-bordered table-striped text-center">
    ...
    <tfoot>
        <tr>
            ...
            <th>Rp.&nbsp;{{ number_format($periode->pembelian->sum('harga_super')) }}</th>
            <th>Rp.&nbsp;{{ number_format($periode->pembelian->sum('total_biaya_beli')) }}</th>
            <th></th>
        </tr>
    </tfoot>
</table>