...
<div class="modal fade" id="create">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('pembelian-produksi-dagang.store') }}" method="post">
                @csrf
...
<div class="modal fade" id="edit-{{ $item->id }}">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('pembelian-produksi-dagang.update',$item->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <form action="{{ route('pembelian-produksi-dagang.destroy',$item->id) }}" method="post">
                    @csrf
                    @method('DELETE')
            ...
            <td>
                <div class="btn-group btn-group-sm">
                    ...
                    <a class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#delete-{{ $item->id }}"
                        type="button"><i class="fas fa-trash"></i>&nbsp; Hapus
                    </a>
                </div>
            </td>
        </tr>
