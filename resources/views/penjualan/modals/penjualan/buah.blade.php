<!-- Modal Create Start -->
<div class="modal fade" id="createPenjualanBuah">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('penjualan-produksi-buah.store') }}" method="post">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-3">Sisa Tonase Beli</div>
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ $sortir }}" id="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="edit-{{ $item->id }}">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('penjualan-produksi-buah.update',$item->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="form-group">
