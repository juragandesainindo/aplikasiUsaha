<!-- Modal Create Start -->
<div class="modal fade" id="createPenjualanTernak">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('penjualan-produksi-ternak.store') }}" method="post">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-3">Sisa Qty Beli</div>
                            <div class="col-9">
                                <input type="text" class="form-control" value="{{ $qtyTernak }}" id="" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Qty Jual (Ekor)</label>
...
<div class="modal fade" id="editTernak-{{ $item->id }}">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('penjualan-produksi-ternak.update',$item->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <form action="{{ route('penjualan-produksi-ternak.destroy',$item->id) }}" method="post">
                    @csrf
                    @method('DELETE')
